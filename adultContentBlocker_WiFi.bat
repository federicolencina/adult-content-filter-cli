REM -Adult Content Blocker- (WiFi) | Federico Lencina | -<https://github.com/len-sch>-
...
if /I "%dialVal%"== "y" (
    ...
    netsh interface ipv4 set dnsservers name="WiFi" source=STATIC address=1.1.1.1 > nul 2>&1
    netsh interface ipv6 set dnsservers name="WiFi" source= STATIC address=2606:4700:4700::1111 > nul 2>&1
    netsh interface ipv4 add dnsservers name="WiFi" address=1.0.0.1 > nul 2>&1
    netsh interface ipv6 add dnsservers name="WiFi" address=2606:4700:4700::1001 > nul 2>&1
    ipconfig /flushdns > nul
